...
/// query the usres table to find out the orignal poster
    ...
    <div class="container my-3">
        <div class="container my-4">
            <div class="jumbotron">
                ...
                <hr class="my-4">
                <p><em>This is a peer to peer forum. No Spam / Advertising / Self-promote in the forums is not allowed.
                        Do
                        not
                        post copyright-infringing material. Do not post “offensive” posts, links or images. Do not cross
                        post
                        questions. Remain respectful of other members at all times.</em></p>
    ...
    echo '<div class="container">
        ...
        <h1 class="py-2 my-3">Post a Comment</h1> 
           <p class="lead text-danger">You are not logged in. Please login to be able to post comments!</p>
        </div>
        ';
    }
    ?>
    ...
    ?>
            ...
            <?php  include 'partial/_foter.php';?>
